...
import { getHomeHead } from "@/src/server/seo";
...
export const Route = createFileRoute("/")({
	...
	loader: async ({ deps }) => ({
		content: await renderLegacyRoute({ data: { route: "home", search: deps } }),
		head: asHead(await getHomeHead({ data: { category: deps.category } })),
	}),
	head: ({ loaderData }) => {
