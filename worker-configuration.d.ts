/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4bb74261a175ca900ada76c6296952d)
// Runtime types generated with workerd@1.20260730.1 2026-02-28 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	GITHUB_CLIENT_ID: string;
	GITHUB_CLIENT_SECRET: string;
	ONEDOLLARSTATS_API_KEY: string;
	SITE_URL: string;
	BLOG_API_URL: string;
}
